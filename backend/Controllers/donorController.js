...
//     let { userId, inventoryType, bloodGroup, quantity, organisation } =
//       req.body;
...
//     const orgUser = await userModel.findById(organisation);
...
//       bloodGroup,
//       quantity,
//       organisation: orgUser._id, // used in both in and out
//     };

//     const inventory = new userInventoryModel(inventoryData);
